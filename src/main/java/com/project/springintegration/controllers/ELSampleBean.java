package com.project.springintegration.controllers;
...
public class ELSampleBean implements Serializable{
    ...
    public void init() {
        ...
        FacesContext.getCurrentInstance().getApplication().addELContextListener((ELContextEvent evt) -> {
            evt.getELContext().getImportHandler().importClass("com.project.springintegration.controllers.ELSampleBean");
        });
    }
